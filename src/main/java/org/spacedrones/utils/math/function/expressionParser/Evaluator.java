...
import org.spacedrones.utils.math.data.RandomMatrix;
...
public class Evaluator
{
	...
	/***
     * creates an empty MathEvaluator. You need to use setExpression(String s) to assign a jat.math expression string to it.
     */
	public Evaluator()
	{
    	init();
    ...
    /***
     * creates a MathEvaluator and assign the jat.math expression string.
     */
