package org.spacedrones.utils.math.data.arrayTools;
 ...
 * ------------------------ */
   ...
   /** Find a value.
   @param a    Double array to jat.test.
  ...
  public Find(double[][] a, double v) {
   ...
   /** Find elements verifying a jat.test.
   @param a    Double array to jat.test.
   @param t    Test : "==", "<=", ">=", "<", ">", "!=".
   @param v    Value to compare.
   */
 ...
 * ------------------------ */
  ...
  /** Get the indices verifying the jat.test.
   @return  2D-indices.
   */
  ...
  public int[][] getIndices() {
   ...
   /** Get the boolean array of the jat.test (true / false).
  ...
  public boolean[][] getBooleanArray() {
   ...
   /** Get the double array of the jat.test (1D / 0D).
 ...
 * ------------------------ */
   ...
   @param ind    Indices verifying the jat.test.
   @param a    Array to jat.test
  ...
  private double[][] setDoubleArray(int[][] ind, double[][] a) {
    ...
    /** Find elements verifying the jat.test.
   @param a    Double array to jat.test.
   @param t    String of the jat.test.
   @param v    Value to jat.test
   @return  Double array.
   */
